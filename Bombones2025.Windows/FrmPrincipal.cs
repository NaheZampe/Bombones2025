...
namespace Bombones2025.Windows
{
    public partial class FrmPrincipal : Form
    {
        ...
        {
            IClienteServicio clienteServicio = AppServices.ServiceProvider!
            ...
            IPaisServicio paisServicio = AppServices.ServiceProvider!
                    .GetRequiredService<IPaisServicio>();
            IMapper mapper = AppServices.ServiceProvider!.GetRequiredService<IMapper>();
            FrmCliente frm = new FrmCliente(mapper, clienteServicio,ciudadServicio,provinciaServicio,paisServicio)
