    ...
    public static class GridHelper
    {
        public static void MostrarDatosEnGrilla<T>(DataGridView dgv, List<T> lista) where T : class
        {
            foreach (T item in lista) {
                DataGridViewRow r = ConstruirFila(dgv);
                SetearFila(r, item);
                AgregarFila(r, dgv);
            }
        }
        ...
        public static void SetearFila(DataGridViewRow r, object obj)
        {
            switch (obj)
            {
                ...
                case CiudadListDto ciudadDto:
                    ...
                    break;
                case ClienteListDto clienteListDto:
                    r.Cells[0].Value = clienteListDto.ClienteId;
                    r.Cells[1].Value = clienteListDto.Apellido + " " +clienteListDto.Nombre;
                    r.Cells[2].Value = clienteListDto.Email;
                    r.Cells[3].Value = clienteListDto.Telefono;
                    r.Cells[4].Value = clienteListDto.Direccion;
                    r.Cells[5].Value = clienteListDto.NombreCiudad;
                    r.Cells[6].Value = clienteListDto.AutorizadoCuentaCorriente? "Si":"No";
                    r.Cells[7].Value = clienteListDto.SaldoCuentaCorriente;
                    break;
